...
static const char* long_options_descriptions[][2] = {
    ...
    [OPT_DECORATION_THEME] = { arg_name, "Window decoration theme: none, dark, auto (default: auto)" },
