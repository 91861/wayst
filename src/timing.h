...
__attribute__((always_inline))
static inline void
TimePoint_add(TimePoint* self, TimePoint offset)
{
...
TimePoint_get_secs(TimePoint* self)
{
...
__attribute__((always_inline))
static inline int64_t
TimePoint_get_nsecs(TimePoint* self)
{
...
__attribute__((always_inline))
static inline void
TimePoint_subtract(TimePoint* self, TimePoint other)
{
...
__attribute__((always_inline))
static inline TimePoint
TimePoint_ms_from_now(uint32_t ms_offset)
{
    struct timespec t;
    clock_gettime(CLOCK_MONOTONIC, &t);
...
__attribute__((always_inline))
static inline TimePoint
TimePoint_s_from_now(uint32_t s_offset)
{
    struct timespec t;
    clock_gettime(CLOCK_MONOTONIC, &t);
...
__attribute__((always_inline))
static inline bool
TimePoint_is_earlier(TimePoint t, TimePoint other)
{
...
__attribute__((always_inline))
static inline Timer
Timer_new(TimePoint start, TimePoint end)
{
...
__attribute__((always_inline))
static inline Timer
Timer_from_now_to(TimePoint end)
{
...
__attribute__((always_inline))
static inline float
Timer_get_fraction_for(Timer* self, TimePoint point)
{
...
__attribute__((always_inline))
static inline float
Timer_get_fraction_now(Timer* self)
{
